    ...
    <div class="container mt-5">
        ...
        <form action="index.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Aluno" value="<?php echo htmlspecialchars($nota['NomeAluno']); ?>" disabled>
            </div>

            <div class="mb-3">
                <label for="Modulo" class="form-label">Módulo</label>
                <input type="text" class="form-control" id="Modulo" value="<?php echo htmlspecialchars($nota['NomeModulo']); ?>" disabled>
            </div>
