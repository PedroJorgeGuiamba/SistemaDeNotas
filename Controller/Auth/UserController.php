...
class UserController {
    ...
    error_log("API Response: " . print_r($result, true)); // Debug
    if (isset($result['error'])) {
        ...
        if (isset($result['user_id']) && isset($result['tipo'])) {
            ...
            error_log("Session set: user_id=" . $_SESSION['user_id'] . ", tipo=" . $_SESSION['tipo']); // Debug
            header('Location: index.php');
        } else {
            error_log("Missing keys in result: " . print_r($result, true)); // Debug
